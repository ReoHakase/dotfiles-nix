{
  ...
  inputs = {
    ...
    nixpkgs-starship.url = "github:NixOS/nixpkgs/f6a968a5d12e2e8cded79eb5834b164540ee2ea2";
    ...
    reohakase-skills = {
      url = "github:ReoHakase/skills/22342e90d2834d36f8748a994aa9ed6911b63d4c";
      flake = false;
    };
